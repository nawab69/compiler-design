...
{
       7,     0,    -1,     8,    -1,     8,     9,    -1,    -1,    10,
       5,    -1,     5,    -1,     1,     5,    -1,     3,    10,     4,
      -1,     3,     4,    -1
};
...
{
  "$end", "error", "$undefined", "A", "B", "EOL", "$accept", "program",
  "lines", "line", "anbn", 0
};
#endif
...
#line 12 "anbn.y"
  ...
  case 5:
#line 21 "anbn.y"
    { printf("Valid string: Matches a^n b^n grammar (n > 0)\n"); }
    break;
